        ...
        <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-xl">
              Advanced AI-powered healthcare platform for clinical decision support and patient safety management.
            </p>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="my-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-4 bg-transparent text-sm text-gray-400">Or continue with</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-3 bg-white/5 border border-white/10 text-gray-300 rounded-xl hover:bg-white/10 transition-all"
                >
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <p className="text-center text-gray-400 text-sm">
                  New to MediAI?{' '}
                  <Link href="/register" className="text-white hover:text-blue-400 font-medium">
                    Create account
                  </Link>
                </p>
              </div>
